...
- Consequences: derive the loss budget before comparing known gaps. The 125-126-session fixed blocks set a 1% ceiling that permits one isolated source loss but rejects two per block. A two-sided 95% exact Clopper-Pearson test over 1,499 full sessions admits seven losses but rejects eight, so the exact global cap remains `7/1499`, about 0.46698%. The five known MDY dates become fixed quarantines and leave two isolated unexpected slots under annual, fixed-block, rolling-quarter, adjacency, same-symbol annual, and zero-initial-context controls. Three deterministic SPY morning quartile-tail tests use Bonferroni alpha `0.05/3`, fixed rejection counts, and automatic failure when required SPY diagnostic bars are absent. Hash-bound issuer evidence for every traded ETF records current 0-2-bps 30-day median full spreads; 6 bps per side remains a conservative planning assumption but not a historical upper bound. A future one-use qualification would use twenty-two exact sessions, twenty-six paired logical chains, at most sixty responses and 64 MiB, and no strategy calculation. A later full pair would contain 3,093,636 expected rows and at most 3,018 additional one-session chains after qualification reuse. Plan SHA-256/fingerprint is `52411a34c267637418df24835476093fd1d5586b9b7912a423848219f04dcc40` / `e6b6a9c30059f91d9c66be42320d3847933e0d5caf56d12a13579e14c801002e`; evidence SHA-256/fingerprint is `68f95b417bf287506eb123441f83344d5337acee2df3227052d9434b0e07de87` / `bb389757b60777cc20549c58201b71f130151dfb1ec65d2959ec1b082f911c2e`; independent review is pending. Every authority remains false.
