...
- Context: Programs 003 and 004 generated and exposed zero strategy returns, and Program 004 made no purchase or source request. Current official Alpaca pages document free Basic historical SIP outside the latest fifteen minutes, history since 2016, inclusive bounds, 10,000-point token pagination, documented adjustments, and 200 requests per minute. The already-exposed five-session MDY defect permits a new return-blind whole-session design but does not permit filling, reranking, or tuning from returns. The current customer agreement does not expressly grant the immutable private retention needed for exact campaign reproduction.
- Consequences: the five known MDY dates become fixed quarantines. The independently derived 0.5% ceiling permits seven total full-session exclusions and leaves two isolated unexpected slots under fixed-block, rolling-quarter, adjacency, same-symbol annual, and zero-initial-context controls. A future one-use qualification would use twenty-two exact sessions, twenty-six paired logical chains, at most sixty responses and 64 MiB, and no strategy calculation. A later full pair would contain 3,093,636 expected rows and at most 3,018 additional one-session chains after qualification reuse. Plan SHA-256/fingerprint is `2a7b49163e8c47712a7b762f67f1229e712db7069f32e777f5bb07610ac6146a` / `09f32075e651f95bb4fc882c0d032955e76ccd5f3abc2a4fa0a56357e82fc556`; independent review is pending. Every authority remains false.
