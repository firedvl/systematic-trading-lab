...
- Consequences: under one consistent session scale, returns, SPY residuals, ranks, top-three selection, fractional equal-dollar notional, bps costs, P&L, dollar-volume capacity, equity, and drawdown are invariant. Integer shares, per-share fees, dividend smoothing, raw redistribution, provider blending, and silent correction refreshes are prohibited. Plan SHA-256/fingerprint is `d4bfdd87575cbf2ccebf6c14fa87aaf58e3585d31dc6bfe443f1d42427177784` / `e6d228a3d256e611985f2185d1db50cba2481b2a441977e71f46903b1876d19b`; independent review is pending. No purchase, subscription, credential, request, download, dataset admission, strategy return, controlled/protected access, PAPER action, broker write, or live action occurred.
