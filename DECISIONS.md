...
- Decision: record Program 006 source qualification as `FAIL`, preserve its private active authority, claim, pages, checkpoints, locks, and terminal failure record unchanged, and prohibit replay or replacement authority. Admit only aggregate terminal evidence and its review to public Git.
