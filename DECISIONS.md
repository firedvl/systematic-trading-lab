...
- Revisit after a clean merge. The next phase, if separately requested, is a new reviewed exact one-use Program 010 authority proposal with fixed real transport and ignored persistent storage. Do not derive its root or execute it here.
