...
import systematic_trading_lab.intraday_fed_policy_absorption_001_cli as cli_module
...
from systematic_trading_lab.intraday_fed_policy_absorption_001_plan import PROGRAM_ID
...
def test_cli_delegates_and_enforces_research_boundaries(
    ...
    monkeypatch.setattr(cli_module, "relative_volume_main", delegated)
...
def test_parser_keeps_worker_count_outside_run_identity() -> None:
    parsed = cli_module.intraday_fed_policy_absorption_parser().parse_args(
        ("run", "--workers", "6")
    )
