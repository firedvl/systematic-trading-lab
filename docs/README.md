...
- [Intraday Event Opening Breakout 001 program](research-campaigns/intraday-event-opening-breakout-001-program.md) — prospective SPY-only scheduled-event opening-range contract
