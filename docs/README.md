...
- [Program 007 corporate-action metadata qualification](program-007-corporate-action-metadata-qualification.md) — blocked one-use proposal, credential preflight, exact request plan, and consumption boundary
