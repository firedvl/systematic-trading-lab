...
- [Program 007 raw source contract](research-campaigns/program-007-raw-source-contract-implementation-v3.md) — synthetic-only execution, raw-first retention, RTH projection, pagination, and the incomplete-ledger admission block
