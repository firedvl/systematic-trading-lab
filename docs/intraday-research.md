...
`intraday-backtest-report-v1` is deterministic and self-contained. It binds the full experiment provenance, replay artifact fingerprint, and report fingerprint. It records failed runs in the registry and reports zero-trade runs without dropping them.
