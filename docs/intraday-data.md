...
3. The Alpaca historical adapter was already read-only and paginated, but it rejected non-daily requests and discarded intraday clock time. It now supports `1Min` and `5Min` without adding any order API.
