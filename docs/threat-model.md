...
Residual risks: local filesystem access can replace local databases and artifacts; the fixture calendar handles weekdays rather than exchange holidays; dependency provenance is not yet attested; Alpaca paper fills do not model market impact, queue position, or full liquidity. Reassess again before enabling paper writes, webhooks, remote artifact storage, or any live planning.
